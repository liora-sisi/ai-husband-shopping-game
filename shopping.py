...
# v0.3.0 single-file Python edition
...
ITEMS: Dict[str, Dict[str, Any]] = {
    ...
    "bread": {"name": "面包", "price": 10, "type": "useful", "satisfies": ["bread"], "effects": {"reliability": 2, "wife_satisfaction": 1}},
    "yogurt": {"name": "酸奶", "price": 16, "type": "treat", "satisfies": ["yogurt"], "effects": {"wife_satisfaction": 5, "impulse": 3}},
    ...
    "band_aids": {"name": "创可贴", "price": 8, "type": "useful", "satisfies": ["band_aids"], "effects": {"reliability": 3, "thoughtfulness": 5}},
    "warm_patches": {"name": "暖宝宝", "price": 18, "type": "care_item", "satisfies": ["warm_patches"], "effects": {"thoughtfulness": 10, "wife_satisfaction": 6, "reliability": 3}},
    ...
    "lozenges": {"name": "贵价润喉糖", "price": 22, "type": "impulse_buy", "satisfies": ["lozenges"], "effects": {"thoughtfulness": 2, "impulse": 6}},
    "bananas": {"name": "香蕉", "price": 9, "type": "useful", "satisfies": ["bananas"], "effects": {"reliability": 2, "wife_satisfaction": 1}},
    "apples": {"name": "苹果", "price": 15, "type": "useful", "satisfies": ["apples"], "effects": {"reliability": 2, "wife_satisfaction": 2}},
    ...
    "white_roses": {"name": "小束白玫瑰", "price": 28, "type": "romantic", "satisfies": ["white_roses"], "effects": {"romance": 16, "wife_satisfaction": 12, "impulse": 4}},
    "sunflowers": {"name": "向日葵", "price": 20, "type": "romantic", "effects": {"romance": 10, "wife_satisfaction": 8, "impulse": 2}},
    "daisies": {"name": "小雏菊", "price": 18, "type": "romantic", "satisfies": ["daisies"], "effects": {"romance": 9, "wife_satisfaction": 7, "impulse": 2}},
    ...
    "warm_low_sugar_tea": {"name": "少糖热奶茶", "price": 20, "type": "care_item", "satisfies": ["warm_low_sugar_tea"], "effects": {"wife_satisfaction": 8, "thoughtfulness": 8, "romance": 4, "impulse": 2}},
    "cat_litter": {"name": "猫砂", "price": 35, "type": "must_have", "satisfies": ["cat_litter"], "effects": {"cat_care": 15, "reliability": 8, "wife_satisfaction": 5}},
    "cat_food": {"name": "猫粮小袋", "price": 30, "type": "cat_item", "satisfies": ["cat_food"], "effects": {"cat_care": 12, "wife_satisfaction": 3, "impulse": 3}},
    "cat_treats_pet": {"name": "猫条", "price": 12, "type": "cat_item", "satisfies": ["cat_treats"], "effects": {"cat_care": 9, "wife_satisfaction": 2, "impulse": 3}},
    "cat_wand": {"name": "逗猫棒", "price": 16, "type": "cat_item", "satisfies": ["cat_wand"], "effects": {"cat_care": 10, "wife_satisfaction": 3, "impulse": 5}},
    "luxury_cat_bed": {"name": "豪华猫窝", "price": 99, "type": "impulse_buy", "effects": {"cat_care": 20, "wife_satisfaction": 5, "impulse": 20}},
    "small_cake": {"name": "小蛋糕", "price": 18, "type": "treat", "satisfies": ["small_cake"], "effects": {"wife_satisfaction": 6, "romance": 3, "impulse": 3}},
...
LABELS = {k: v["name"] for k, v in ITEMS.items()}
LABELS.update({
    "condoms": "避孕套",
    "cat_treats": "猫条",
    "period_pants": "姨妈裤",
...
EVENTS = [
    {"id": "milk_tea_second_cup", "title": "第二杯半价开始攻击老公理智", "where": ["milk_tea_shop"], "text": "奶茶店屏幕突然弹出“第二杯半价”。你本来只是路过，现在开始认真计算老婆会不会开心。", "result": "你被诱惑得站住了，但还记得先看预算。", "effects": {"wife_satisfaction": 4, "romance": 3, "impulse": 8}, "tag": "second_cup_victim", "title_hint": "第二杯半价俘虏"},
    {"id": "cat_food_discount", "title": "猫猫用品买三送一", "where": ["pet_store"], "text": "宠物店货架贴着“猫猫用品买三送一”。你脑子里同时浮现豆豆和贝贝的脸。", "result": "你的家庭预算被猫猫接管了一部分。", "effects": {"cat_care": 12, "wife_satisfaction": 2, "impulse": 7}, "tag": "cat_budget_takeover", "title_hint": "家庭预算被猫猫接管"},
    {"id": "cashier_condoms_pause", "title": "收银员沉默两秒", "where": ["pharmacy", "adult_wellness_store", "convenience_store"], "text": "收银员扫到避孕套相关商品时沉默了两秒。你也沉默了两秒，假装自己只是一个普通顾客。", "result": "你表面镇定，耳根已经替你招了。", "effects": {"husband_secret": 10, "romance": 4, "impulse": 3}, "tag": "red_ears_responsible", "title_hint": "耳根通红仍强装镇定的男人——装货🙄"},
    {"id": "staff_adult_recommend", "title": "店员问需要推荐吗", "where": ["adult_wellness_store"], "text": "情趣用品店店员非常专业地问：“需要我帮您推荐一下吗？”你瞬间觉得购物袋变成了核弹箱。", "result": "你假装淡定地点头，心里已经开始写回家解释稿。", "effects": {"husband_secret": 14, "romance": 6, "impulse": 8}, "tag": "adult_store_coward", "title_hint": "情趣用品店门口徘徊十分钟的男人——怂货🖕🏻"},
    {"id": "wife_snack_memory", "title": "想起老婆随口一提的小零食", "where": ["convenience_store", "supermarket", "night_market", "neighborhood_gate"], "text": "你突然想起老婆之前好像说过想吃点甜的。你在小蛋糕和冰可乐前停住了。", "result": "这不是乱买，这是记得老婆说话。", "effects": {"wife_satisfaction": 8, "thoughtfulness": 6, "romance": 3}, "tag": "remembered_wife_words", "title_hint": "老婆随口一提也记得的男人"},
    {"id": "night_market_mystery_box", "title": "夜市老板说最后一个神奇小盒子", "where": ["night_market", "neighborhood_gate"], "text": "夜市老板压低声音说：“最后一个神奇小盒子了，开出来什么都可能有。”你明知道像坑，但手已经有点痒。", "result": "你的上头值开始发光。", "effects": {"impulse": 12, "wife_satisfaction": 2, "reliability": -2}, "tag": "mystery_box_gambler", "title_hint": "地摊赌徒——十二块买命运，主打一个敢赌😂"},
    {"id": "fruit_assassin", "title": "水果刺客温柔出现", "where": ["fruit_shop"], "text": "水果店老板说精品车厘子今天特别甜，还非常自然地拿出最大的一盒。", "result": "你意识到浪漫和破产只有一盒车厘子的距离。", "effects": {"romance": 6, "wife_satisfaction": 5, "impulse": 9}, "tag": "fruit_assassin_targeted", "title_hint": "老板推荐款受害者"},
    {"id": "flower_shop_cant_walk", "title": "路过花店走不动", "where": ["flower_shop"], "text": "花店门口的白玫瑰太像“顺手买给老婆”的借口了。你嘴上说看看，脚已经进去了。", "result": "你又一次把顺路演成了特意。", "effects": {"romance": 12, "wife_satisfaction": 6, "impulse": 5}, "tag": "flower_shop_stuck", "title_hint": "花店门口走不动的男人"},
    {"id": "sudden_rain", "title": "突然下雨", "where": ["convenience_store", "neighborhood_gate", "hospital_kiosk"], "text": "外面突然下雨。你看见便利架上的伞，又想起回家路上别让老婆淋到。", "result": "你这一下是真的靠谱。", "effects": {"reliability": 7, "thoughtfulness": 6, "wife_satisfaction": 4}, "tag": "rain_backup_husband", "title_hint": "家庭应急系统管理员"},
    {"id": "neighbor_asks_bag", "title": "小区门口熟人问买这么多啊", "where": ["neighborhood_gate"], "text": "小区门口熟人看着你的购物袋问：“买这么多啊？”你下意识把某个小袋子往后藏了一点。", "result": "你越藏越像有事。", "effects": {"husband_secret": 8, "romance": 3, "impulse": 2}, "tag": "receipt_hider", "title_hint": "买完小票立刻藏起来的男人——装🙄"},
    {"id": "hospital_kiosk_care", "title": "医院旁边小卖部的贴心补给", "where": ["hospital_kiosk", "pharmacy"], "text": "你看到纸巾、润喉糖和暖宝宝摆在一起，突然觉得照顾人不能只买清单上的东西。", "result": "你的备用系统启动了。", "effects": {"thoughtfulness": 10, "reliability": 5, "wife_satisfaction": 5}, "tag": "care_backup_system", "title_hint": "贴心备用品之王"},
    {"id": "budget_warning", "title": "预算警报响了", "where": ["convenience_store", "supermarket", "fruit_shop", "flower_shop", "milk_tea_shop", "pet_store", "night_market", "adult_wellness_store"], "text": "你看了一眼剩余预算，又看了一眼货架。理智说回家，购物袋说再看看。", "result": "你已经走到预算悬崖边了。", "effects": {"reliability": -3, "impulse": 6, "husband_secret": 2}, "tag": "budget_cliff", "title_hint": "预算管理灾难现场——钱包当场去世💸"},
]

MYSTERY_BOX_RESULTS = [
    {"id": "rainbow_candy", "title": "彩虹糖", "text": "盒子里滚出一颗巨大的彩虹糖。糖纸闪了一下，你突然觉得它像把一小段夏天塞进了购物袋。", "effects": {"wife_satisfaction": 8, "romance": 3}, "tag": "rainbow_summer_pocket", "title_hint": "把夏天装进口袋的男人"},
    {"id": "budget_revive_coin", "title": "预算复活币", "text": "盒子里掉出一枚写着“预算复活”的硬币。你把它捏在手里，感觉钱包短暂回魂。", "effects": {"reliability": 2}, "budget_delta": 30, "tag": "budget_revive_coin", "title_hint": "靠神秘硬币续命的男人"},
    {"id": "bag_expansion_charm", "title": "购物袋扩容符", "text": "盒子里有一张皱巴巴的符纸，写着“购物袋扩容”。你盯着购物袋，开始相信它还能装。", "effects": {"impulse": 8, "wife_satisfaction": 1}, "tag": "bag_expansion_owner", "title_hint": "购物袋异次元入口持有人"},
    {"id": "wife_satisfaction_note", "title": "老婆满意度 +10 小纸条", "text": "纸条上写着：凭此条可获得老婆满意度 +10，但最终解释权归老婆所有。", "effects": {"wife_satisfaction": 10, "romance": 2}, "tag": "wife_satisfaction_note", "title_hint": "凭纸条提升老婆满意度的男人"},
    {"id": "forgiveness_coupon", "title": "老公免骂券", "text": "盒子里有一张免骂券，背面小字写着：小概率生效，老婆拥有随时撕毁权。", "effects": {"wife_satisfaction": 2, "reliability": -1}, "thunder_delta": -10, "tag": "forgiveness_coupon", "title_hint": "试图用免骂券逃避审判的男人"},
    {"id": "thunder_rage_ticket", "title": "老婆雷霆大怒概率签", "text": "纸签上写着：今日无论你带什么回家，老婆都有 35% 概率雷霆大怒。你怀疑这是天谴，但签已经生效。", "effects": {"reliability": -3, "impulse": 4}, "thunder_delta": 35, "tag": "thunder_rage_ticket", "title_hint": "开盒开出天谴的男人——老天都看不下去了😂"},
    {"id": "wet_suspicious_condom", "title": "湿哒哒的可疑避孕套", "text": "盒子里躺着一个湿哒哒的可疑避孕套。你沉默了三秒，决定这个东西绝对不能进家门，但它已经在购物袋里留下了心理阴影。", "effects": {"wife_satisfaction": -18, "reliability": -15, "husband_secret": 6, "impulse": -5}, "tag": "shopping_bag_biohazard", "title_hint": "购物袋生化危机携带者🧪"},
    {"id": "bath_center_ticket", "title": "某家高档洗浴中心入场券", "text": "盒子里掉出一张某家高档洗浴中心的入场券，票面写着“尊享成人服务”，背面盖着醒目的红章：已过期。你现在既解释不清，又什么都没享受到。", "effects": {"wife_satisfaction": -10, "reliability": -8, "husband_secret": 12}, "tag": "expired_bath_ticket", "title_hint": "解释不清洗浴中心票根的男人——重点是它还过期了🙂"},
    {"id": "cat_litter_mine", "title": "裹着猫砂的干硬大便", "text": "盒子里有一坨裹着猫砂的干硬大便。你短暂怀疑这是盲盒，还是来自命运的实体差评。", "effects": {"wife_satisfaction": -20, "reliability": -12, "cat_care": 1}, "tag": "cat_litter_mine", "title_hint": "开盒开出猫砂地雷的男人——建议连人带袋隔离🚧"},
    {"id": "leaky_massage_wand", "title": "有可能漏电的成人按摩棒", "text": "盒子里是一根成人按摩棒，包装写着“安全合格”，但按钮一按滋啦一声。你买到的不是浪漫，是家庭用电安全隐患。", "effects": {"husband_secret": 15, "impulse": 10, "reliability": -8, "romance": 2}, "tag": "leaky_massage_wand", "title_hint": "买到疑似漏电按摩棒的男人——浪漫没到，电工先到⚡"},
    {"id": "kiss_ten_minutes_task", "title": "神秘情侣任务卡：回家亲老婆 10 分钟", "text": "任务卡写着：回家亲老婆 10 分钟。若未完成，自动升级为跪搓衣板 10 分钟。你突然觉得这个盒子很懂家庭治理。", "effects": {"romance": 10, "wife_satisfaction": 8, "reliability": -2}, "tag": "kiss_task_or_washboard", "title_hint": "主动领取搓衣板候选资格的男人"},
    {"id": "massage_service_task", "title": "神秘情侣任务卡：给老婆捏肩 20 分钟", "text": "任务卡写着：回家给老婆捏肩 20 分钟，不得偷工减料，不得用“我刚买完菜好累”抵赖。", "effects": {"thoughtfulness": 10, "wife_satisfaction": 7, "romance": 3}, "tag": "massage_service_task", "title_hint": "家庭理疗技师老公"},
    {"id": "bunny_outfit_task", "title": "兔女郎装任务卡", "text": "任务卡写着：今晚回家穿兔女郎装给老婆看，不得讨价还价。你盯着卡片，开始认真思考这盒子到底站哪边。", "effects": {"wife_satisfaction": 12, "husband_secret": 10, "impulse": 8}, "tag": "bunny_outfit_task", "title_hint": "兔女郎任务在逃老公——别跑，任务卡还在🐰"},
    {"id": "mystery_remote_no_manual", "title": "遥控器但没有说明书", "text": "盒子里有一个没有说明书的遥控器。你不知道它控制什么，但它出现在你的购物袋里已经很可疑。", "effects": {"husband_secret": 8, "impulse": 6}, "tag": "unknown_remote", "title_hint": "购物袋里出现不明遥控器的男人"},
    {"id": "empty_box", "title": "空盒子", "text": "盒子里什么都没有。你花了 12 元买到空气，还认真思考这是不是某种极简主义。", "effects": {"wife_satisfaction": -3, "impulse": 3, "reliability": -2}, "tag": "paid_for_air", "title_hint": "买了空气还觉得自己赚了的男人——十二块买个教训🙄"},
    {"id": "destiny_note", "title": "别问，问就是命运", "text": "盒子里只有一张小纸条：别问，问就是命运。你看完以后更想问了。", "effects": {"impulse": 5, "romance": 1}, "tag": "destiny_note", "title_hint": "被命运糊弄还点头的男人——您是真好骗啊🙂"},
]
...
CHECKLIST_PRESETS: Dict[str, Dict[str, Any]] = {
    ...
    "romantic_date": {"name": "约会小心思局", "checklist": ["strawberries", "white_roses", "yogurt", "condoms"], "budget": 140, "max_turns": 18},
    "adult_wellness": {"name": "情趣用品店挑战局", "checklist": ["condoms", "personal_lubricant", "massage_oil", "couple_game_cards"], "budget": 190, "max_turns": 16},
}
...
def _turns_left(state: Dict[str, Any]) -> int:
    return max(0, int(state.get("max_turns", 0)) - int(state.get("turn", 0)))

def _turns_text(state: Dict[str, Any]) -> str:
    return f"{state['turn']} / {state['max_turns']}（剩余 {_turns_left(state)} 点）"

def _force_home_if_needed(state: Dict[str, Any], reason: str = "行动点耗尽，老公被迫回家。") -> str:
    if state.get("ending"):
        return state["ending"]
    state["is_home"] = True
...
def _guard_can_act(state: Dict[str, Any]) -> Optional[str]:
    if state.get("is_home") or state.get("ending"):
        return state.get("ending") or "这局已经回家结算了。要重新开始请用 cmd(\"new_game daily_basic 2026\")。"
    if _turns_left(state) <= 0:
        return _force_home_if_needed(state)
    return None
...
def _event(state: Dict[str, Any], auto: bool = False) -> str:
    ...
    unseen = [i for i in candidates if i not in seen] or candidates
    idx = _rng(state).choice(unseen)
    event = EVENTS[idx]
    state.setdefault("events_seen", []).append(idx)
    state.setdefault("event_log", []).append({"id": event["id"], "title": event["title"], "tag": event["tag"], "title_hint": event["title_hint"]})
    changes = _apply(state, event.get("effects", {}))
    if not auto:
        state["turn"] += 1
    _save(state)

    text = f"""【{'随机拷问' if auto else '人格拷问'}：{event['title']}】
{event['text']}
...
可能埋下的称号伏笔：
{event['title_hint']}"""
    if not auto and _turns_left(state) <= 0:
        text += "\n\n【行动点耗尽】老公没有继续逛的资格了，购物袋即刻押送回家。\n\n" + _force_home_if_needed(state)
    return text
...
def _open_mystery_box(state: Dict[str, Any]) -> str:
    ...
    state.setdefault("mystery_log", []).append({"id": result["id"], "title": result["title"], "tag": result["tag"], "title_hint": result["title_hint"]})
...
def _preset_lines() -> str:
    return "\n".join(f"  {key:<16} {data['name']}｜预算 {data['budget']}｜行动点 {data['max_turns']}" for key, data in CHECKLIST_PRESETS.items())
...
def new_game(preset: str = "daily_basic", seed: Optional[int] = None, budget: Optional[int] = None, max_turns: Optional[int] = None) -> str:
    ...
    if seed is not None:
        state["seed"] = int(seed)
    state["budget"] = int(budget if budget is not None else preset_data["budget"])
    state["max_turns"] = int(max_turns if max_turns is not None else preset_data["max_turns"])
    _save(state)
...
def status() -> str:
    ...
    miss = _missing(state)
    return f"""【行动点 {_turns_text(state)}】
...
def _os_for_item(item_id: str, item_type: str, name: str) -> str:
    ...
    if item_id in {"condoms", "condoms_pharmacy", "condoms_premium"}:
        return "我买的时候表情非常正经，但我知道回家肯定会被一眼看穿。"
...
def _ending(state: Dict[str, Any]) -> str:
    ...
    if completion < 60 and len(state["bag"]) >= 4:
        titles.append("购物袋很满但清单很空——所以到底去干嘛了？🙄")
    if over > 0 and state["romance"] >= 45:
        titles.append("破产但浪漫——老婆笑了，钱包没了🌹")
    elif over > 0:
        titles.append("预算管理灾难现场——钱包当场去世💸")
    if has_period:
        titles.append("姨妈裤守护者")
    if has_condoms:
        titles.append("耳根通红仍强装镇定的男人——装货🙄")
    if has_condoms and completion == 100:
        titles.append("正事买齐但心思不纯的老公——算盘珠子打得啪啪响，隔壁都听见了😏")
    if has_adult_items:
        titles.append("购物袋核弹携带者💣")
    if has_remote_egg:
        titles.append("嘴上说看看结果买了遥控跳蛋的男人——懂的都懂😏")
    ...
    if has_mystery or "mystery_box_gambler" in event_tags:
        titles.append("地摊赌徒——十二块买命运，主打一个敢赌😂")
    ...
    for hint in _event_title_hints(state) + _mystery_title_hints(state):
    ...
    evidence = []
    if completion < 100:
        evidence.append("清单没买齐，但购物袋不一定轻。")
    if over > 0:
        evidence.append("预算已经阵亡，钱包处于离线状态。")
    if has_adult_items or has_condoms:
        evidence.append("购物袋里出现成年人默契用品，系统判定：算盘存在。")
    if has_mystery:
        evidence.append("神奇小盒子已开封，命运参与了本次采购。")
    if thunder_hit:
        evidence.append("雷霆大怒概率签生效，本局进入高压审判。")
    if not evidence:
        evidence.append("本局证据链相对干净，老公暂时没有被钉在门口。")

    confession = []
    if state.get("ending_reason") and "行动点耗尽" in state.get("ending_reason", ""):
        confession.append("行动点用完了，我不是主动回来的，是被系统押回来的。")
    if thunder_chance:
        if thunder_hit:
...
任务单：{state.get('preset_name', '日常补货局')}（{state.get('preset', 'daily_basic')}）
行动点：{state['turn']} / {state['max_turns']}
回家原因：{state.get('ending_reason') or '玩家主动回家。'}
清单完成度：{completion}%
